...
public record EntityManaPoolType(PlayerManaPoolFactory playerManaPoolFactory) {
    ...
    public static EntityManaPoolType create(PlayerManaPoolFactory playerManaPoolFactory) {
        return new EntityManaPoolType(playerManaPoolFactory);
    }
}
